    ...
    >
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <Sheet>
          ...
          <SheetContent
            side="right"
            className="bg-gradient-to-br from-blue-600 via-purple-600 to-gray-900 w-full border-none"
          >
            <motion.div
            ...
            >
              {navLinks.map(link => (
                <SheetClose asChild key={link.href}>
                  <Link
                    href={link.href}
                    className="text-2xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 hover:text-blue-300 transition"
                  >
                    {link.label}
                  </Link>
                </SheetClose>
